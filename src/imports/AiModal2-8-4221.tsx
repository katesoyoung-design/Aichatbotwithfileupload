import svgPaths from "./svg-q6wytel4sg";
...
function Container15() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start max-w-[1040px] min-w-[840px] overflow-clip relative rounded-[16px] self-stretch shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-[841px]" data-name="Container">
      <Container />
      <Container13 />
      <Container14 />
    </div>
...
function ChatWidget() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[800px] items-center max-w-[375px] min-w-[375px] overflow-clip relative rounded-[16px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-[375px]" data-name="ChatWidget">
      <Top />
      <ToggleAlerts />
      <Chat />
      <Bottom />
...
function InputForms() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0" data-name="input forms">
      <Container15 />
      <ChatWidget />
    </div>
  );
...
function FullScreenMaximize1() {
  return (
    <div className="absolute left-1/2 size-[16px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="fullScreen/maximize">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Maximize">
...
function AiModal() {
  return (
    <div className="absolute content-stretch flex flex-col h-[885px] items-start left-0 top-0 w-[1918px]" data-name="ai-modal">
...
export default function AiModal1() {
  return (
    <div className="bg-white relative size-full" data-name="ai modal-2">
      <AiModal />
    </div>
  );
}