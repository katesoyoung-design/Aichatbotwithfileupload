import svgPaths from "./svg-fq6bh5ccnh";
...
function SelectMenu() {
  return (
    <div className="relative shrink-0 w-full" data-name="_Select menu">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[14px] py-[10px] relative w-full">
          <Content4 />
        </div>
...
function SettingOverflowMenu() {
  return (
    <div className="absolute bg-white right-[16px] rounded-[8px] top-[38.5px] w-[240px]" data-name="setting-overflowMenu">
...
export default function ChatWidget() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-[16px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-full" data-name="ChatWidget-블루퍼플">
      <Top />
      <ToggleAlerts />
      <Chat />
      <SettingOverflowMenu />
