import svgPaths from "./svg-zczxd5kvhn";
...
function ChatWidget() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[885px] items-center max-w-[375px] min-w-[375px] overflow-clip right-0 shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] top-0 w-[375px]" data-name="ChatWidget">
      <Top />
      <ToggleAlerts />
      <Chat />
      <Bottom />
...
export default function AiModal1() {
  return (
    <div className="bg-white relative size-full" data-name="ai modal-3">
      <div className="absolute h-[879px] left-[-2px] top-0 w-[1542px]" data-name="KakaoTalk_20260107_102410568 1">
