import svgPaths from "./svg-v9l6pnwa4n";
import imgKakaoTalk202601071024105681 from "figma:asset/dce6366e28340005db8df9f4715f6f2d10678262.png";

function Content() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 top-0 w-[1543px]" data-name="content">
      <div className="h-[879px] relative shrink-0 w-full" data-name="KakaoTalk_20260107_102410568 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-full left-0 max-w-none top-0 w-[124.06%]" src={imgKakaoTalk202601071024105681} />
        </div>
      </div>
    </div>
  );
...
function Top() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative shadow-[0px_0.15px_0.45px_0px_rgba(0,0,0,0.14)] shrink-0 w-full" data-name="top">
      <Header1 />
    </div>
  );
}
...
function Chat() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="chat" style={{ backgroundImage: "linear-gradient(118.206deg, rgba(240, 245, 253, 0.2) 20.555%, rgba(146, 181, 254, 0.2) 97.413%), linear-gradient(113.04deg, rgb(224, 237, 254) 8.5059%, rgb(207, 227, 255) 68.12%)" }}>
...
function ChatWidget() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[885px] items-center left-[1543px] max-w-[375px] min-w-[375px] overflow-clip shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] top-0 w-[375px]" data-name="ChatWidget">
      <Top />
      <ToggleAlerts />
      <Chat />
      <Bottom />
...
function Tab1() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="tab1">
      <p className="css-ew64yg font-['Noto_Sans:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#101828] text-[18px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        AI 고객 등록
      </p>
    </div>
  );
...
function Container4() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#1c309a] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pb-[2px] pt-0 px-[20px] relative size-full">
          <Tabs1 />
          <Button2 />
        </div>
      </div>
...
function Label() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute css-ew64yg font-['Noto_Sans:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#364153] text-[14px] top-[-1px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        이름
      </p>
    </div>
  );
...
function TextInput() {
  return (
    <div className="h-[46px] relative rounded-[6px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] py-[10px] relative size-full">
          <p className="css-ew64yg font-['Noto_Sans:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#222] text-[16px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
            홍길동
          </p>
        </div>
      </div>
...
function Container5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] h-[74px] items-start min-h-px min-w-px relative" data-name="Container">
      <Label />
      <TextInput />
    </div>
  );
...
function Select() {
  return (
    <div className="bg-[#f5f5f5] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-full" data-name="select">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[12px] py-[8px] relative size-full">
          <p className="css-4hzbpn flex-[1_0_0] font-['Noto_Sans:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[24px] min-h-px min-w-px relative text-[#222] text-[14px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
            선택
          </p>
          <IconChevronDown />
        </div>
...
function TextInput1() {
  return (
    <div className="h-[46px] relative rounded-[6px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] py-[10px] relative size-full">
          <p className="css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#222] text-[14px]">870211</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
...
function LineDuotoneSecurityEye() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Line Duotone / Security / Eye">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Line Duotone / Security / Eye">
          <path d={svgPaths.p1fe8ea00} id="Vector" opacity="0.5" stroke="var(--stroke-0, black)" strokeWidth="1.5" />
          <path d={svgPaths.pcf44f00} id="Vector_2" stroke="var(--stroke-0, black)" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame11() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
      <p className="css-ew64yg font-['Noto_Sans:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#222] text-[14px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        1******
      </p>
      <LineDuotoneSecurityEye />
    </div>
  );
}
...
function Container8() {
  return (
    <div className="bg-[#f5f5f5] flex-[1_0_0] h-[46px] min-h-px min-w-px relative rounded-[6px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#cbd5e1] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <Container7 />
      <p className="css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#364153] text-[14px]">-</p>
      <Container8 />
    </div>
  );
}
...
function Label3() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute css-ew64yg font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#364153] text-[14px] top-[-1px]">전화번호</p>
    </div>
  );
}
...
function PhoneInput() {
  return (
    <div className="flex-[1_0_0] h-[46px] min-h-px min-w-px relative rounded-[6px]" data-name="Phone Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[16px] py-[10px] relative size-full">
          <p className="css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#222] text-[16px] text-center">010</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
...
function Text() {
  return (
    <div className="h-[24px] relative shrink-0 w-[6.563px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#99a1af] text-[16px] top-[-2px]">-</p>
      </div>
    </div>
  );
}
...
function PhoneInput1() {
  return (
    <div className="flex-[1_0_0] h-[46px] min-h-px min-w-px relative rounded-[6px]" data-name="Phone Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[16px] py-[10px] relative size-full">
          <p className="css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#222] text-[16px] text-center">1234</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
...
function PhoneInput2() {
  return (
    <div className="flex-[1_0_0] h-[46px] min-h-px min-w-px relative rounded-[6px]" data-name="Phone Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[16px] py-[10px] relative size-full">
          <p className="css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#222] text-[16px] text-center">5678</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
...
function Select1() {
  return (
    <div className="bg-[#f5f5f5] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-full" data-name="select">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[12px] py-[8px] relative size-full">
          <p className="css-4hzbpn flex-[1_0_0] font-['Noto_Sans:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[24px] min-h-px min-w-px relative text-[#0f172a] text-[14px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
            선택
          </p>
          <IconChevronDown1 />
        </div>
...
function TextInput2() {
  return (
    <div className="bg-[#f5f5f5] h-[46px] relative rounded-[6px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[12px] py-[8px] relative size-full">
          <p className="css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#222] text-[16px]">07330</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#cbd5e1] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
...
function Container12() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[74px] items-start relative shrink-0 w-[180px]" data-name="Container">
      <Label5 />
      <TextInput2 />
    </div>
  );
...
function Label6() {
  return <div className="h-[20px] shrink-0 w-full" data-name="Label" />;
}
...
function TextInput3() {
  return (
    <div className="bg-[#f5f5f5] h-[46px] relative rounded-[6px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[12px] py-[8px] relative size-full">
          <p className="css-ew64yg font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#222] text-[16px]">서울특별시 영등포구 국제금융로 79</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#cbd5e1] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
...
function Full() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="full">
      <Container12 />
      <Container13 />
    </div>
  );
...
function TextInput4() {
  return (
    <div className="bg-white h-[46px] relative rounded-[6px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[12px] py-[8px] relative size-full">
          <p className="css-ew64yg font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#222] text-[16px]">3층 302호</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#cbd5e1] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
...
function Container14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[74px] items-start min-h-px min-w-px relative" data-name="Container">
      <TextInput4 />
    </div>
  );
}
...
function TextInput5() {
  return (
    <div className="h-full relative rounded-[6px] shrink-0 w-[385px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip px-[16px] py-[10px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#222] text-[14px]">kate2025</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Container15() {
  return (
    <div className="bg-white flex-[1_0_0] h-[46px] min-h-px min-w-px relative rounded-[6px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#cbd5e1] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[12px] py-[8px] relative size-full">
          <Frame12 />
...
function Button3() {
  return (
    <div className="h-[36px] relative rounded-[10px] shrink-0 w-[100px]" data-name="Button" style={{ backgroundImage: "linear-gradient(90deg, rgb(77, 113, 218) 0%, rgb(77, 113, 218) 100%), linear-gradient(92.6389deg, rgb(81, 109, 255) 0.81609%, rgb(136, 53, 255) 103.58%), linear-gradient(90deg, rgb(0, 85, 169) 0%, rgb(0, 85, 169) 100%), linear-gradient(90deg, rgb(246, 158, 10) 0%, rgb(246, 158, 10) 100%)" }}>
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[185px] py-0 relative size-full">
          <p className="css-ew64yg font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[16px] text-center text-white">저장</p>
        </div>
      </div>
    </div>
  );
...
function Container18() {
  return (
    <div className="bg-white h-[72px] relative shadow-[4px_0px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full" data-name="Container">
      <div className="flex flex-col items-end justify-center size-full">
        <div className="content-stretch flex flex-col items-end justify-center px-[24px] py-0 relative size-full">
          <Button3 />
        </div>
      </div>
    </div>
...
function Container19() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start max-w-[1040px] min-w-[840px] overflow-clip relative rounded-[16px] self-stretch shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-[1040px]" data-name="Container">
      <Container4 />
      <Container17 />
      <Container18 />
    </div>
...
function InputForms() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="input forms">
      <Container19 />
    </div>
  );
}
...
function Container20() {
  return (
    <div className="h-[800px] relative shrink-0" data-name="container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col h-full items-center justify-center overflow-clip relative rounded-[inherit]">
        <InputForms />
      </div>
    </div>
  );
...
function DimPopup() {
  return (
    <div className="bg-[rgba(0,0,0,0.7)] content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px relative w-full" data-name="dim popup">
      <Container20 />
      <Buttons1 />
    </div>
  );
...
function AiModal() {
  return (
    <div className="absolute content-stretch flex flex-col h-[885px] items-center justify-center left-0 top-0 w-[1543px]" data-name="ai-modal">
      <DimPopup />
    </div>
  );
}
...
export default function AiModal1() {
  return (
    <div className="bg-white relative size-full" data-name="ai modal-3">
      <Content />
      <ChatWidget />
      <AiModal />
    </div>
